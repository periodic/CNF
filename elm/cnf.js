...
var _user$project$Cnf$freeVars = function (expr) {
	freeVars:
	while (true) {
		var _p0 = expr;
		switch (_p0.ctor) {
			case 'Conjunction':
				return A2(
					...
					_user$project$Cnf$freeVars(_p0._0),
					_user$project$Cnf$freeVars(_p0._1));
			case 'Disjunction':
				return A2(
					_elm_lang$core$Set$union,
					_user$project$Cnf$freeVars(_p0._0),
...
var _user$project$Cnf$prettyPrint = function (expr) {
	var _p1 = expr;
	switch (_p1.ctor) {
		case 'Conjunction':
			var _p4 = _p1._1;
			var _p3 = _p1._0;
			var _p2 = {ctor: '_Tuple2', _0: _p3, _1: _p4};
			_v3_3:
			do {
				if (_p2.ctor === '_Tuple2') {
					if (_p2._0.ctor === 'Conjunction') {
						if (_p2._1.ctor === 'Conjunction') {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Cnf$prettyPrint(_p3),
								A2(
									_elm_lang$core$Basics_ops['++'],
									' ∧ ',
									_user$project$Cnf$prettyPrint(_p4)));
						} else {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Cnf$prettyPrint(_p3),
								A2(
									_elm_lang$core$Basics_ops['++'],
									' ∧ ',
									_user$project$Cnf$withParens(_p4)));
						}
					} else {
						if (_p2._1.ctor === 'Conjunction') {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Cnf$withParens(_p3),
								A2(
									_elm_lang$core$Basics_ops['++'],
									' ∧ ',
									_user$project$Cnf$prettyPrint(_p4)));
		...
		case 'Disjunction':
			...
			do {
				if (_p5.ctor === '_Tuple2') {
					if (_p5._0.ctor === 'Disjunction') {
						if (_p5._1.ctor === 'Disjunction') {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Cnf$prettyPrint(_p6),
								A2(
									_elm_lang$core$Basics_ops['++'],
									' ∨ ',
									_user$project$Cnf$prettyPrint(_p7)));
						} else {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Cnf$prettyPrint(_p6),
								A2(
									_elm_lang$core$Basics_ops['++'],
									' ∨ ',
									_user$project$Cnf$withParens(_p5._1)));
						}
					} else {
						if (_p5._1.ctor === 'Disjunction') {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Cnf$withParens(_p5._0),
								A2(
									_elm_lang$core$Basics_ops['++'],
									' ∨ ',
									_user$project$Cnf$prettyPrint(_p7)));
			...
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Cnf$withParens(_p6),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' ∨ ',
					_user$project$Cnf$withParens(_p7)));
		case 'Implication':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Cnf$withParens(_p1._0),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' ⇒ ',
					_user$project$Cnf$withParens(_p1._1)));
		case 'Negation':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'¬',
				_user$project$Cnf$withParens(_p1._0));
		default:
			return _elm_lang$core$String$fromChar(_p1._0);
	}
};
var _user$project$Cnf$withParens = function (expr) {
	var _p8 = expr;
	switch (_p8.ctor) {
		case 'Symbol':
			return _user$project$Cnf$prettyPrint(expr);
		case 'Negation':
			return _user$project$Cnf$prettyPrint(expr);
		default:
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Cnf$prettyPrint(expr),
					')'));
	}
};
var _user$project$Cnf$elem = F3(
	function (e0, es, seed) {
		var _p9 = A2(
			_elm_lang$core$Random$step,
			A2(
				...
				0,
				_elm_lang$core$List$length(es) + 1),
			seed);
		var idx = _p9._0;
		var seed$ = _p9._1;
		var val = A2(
			...
			_elm_lang$core$List$head(
				A2(_elm_lang$core$List$drop, idx, es)));
		return {ctor: '_Tuple2', _0: val, _1: seed$};
	});
var _user$project$Cnf$Symbol = function (a) {
	return {ctor: 'Symbol', _0: a};
};
var _user$project$Cnf$generateTerminal = function (seed) {
	var _p10 = A3(
		_user$project$Cnf$elem,
		_elm_lang$core$Native_Utils.chr('A'),
		_elm_lang$core$Native_List.fromArray(
			[
	...
	return {
		ctor: '_Tuple2',
		_0: _user$project$Cnf$Symbol($char),
		_1: seed$
	};
};
var _user$project$Cnf$Negation = function (a) {
	return {ctor: 'Negation', _0: a};
};
var _user$project$Cnf$Implication = F2(
	function (a, b) {
		return {ctor: 'Implication', _0: a, _1: b};
	});
var _user$project$Cnf$Disjunction = F2(
	function (a, b) {
		return {ctor: 'Disjunction', _0: a, _1: b};
	});
var _user$project$Cnf$Conjunction = F2(
	function (a, b) {
		return {ctor: 'Conjunction', _0: a, _1: b};
	});
var _user$project$Cnf$generateNonTerminal = F2(
	function (size, seed0) {
		if (_elm_lang$core$Native_Utils.eq(size, 1)) {
			var _p11 = _user$project$Cnf$generateTerminal(seed0);
			var expr = _p11._0;
			var seed1 = _p11._1;
			var _p12 = A2(_elm_lang$core$Random$step, _elm_lang$core$Random$bool, seed1);
			var negate = _p12._0;
			var seed2 = _p12._1;
			return negate ? {
				ctor: '_Tuple2',
				_0: _user$project$Cnf$Negation(expr),
				_1: seed2
			} : {ctor: '_Tuple2', _0: expr, _1: seed2};
		} else {
			var _p13 = A2(
				_elm_lang$core$Random$step,
				A2(_elm_lang$core$Random$int, 1, size - 1),
				seed0);
			var leftSize = _p13._0;
			var seed1 = _p13._1;
			...
			var _p14 = A3(
				...
				_elm_lang$core$Native_List.fromArray(
					[_user$project$Cnf$Disjunction, _user$project$Cnf$Implication]),
				seed1);
			var operator = _p14._0;
			var seed2 = _p14._1;
			var _p15 = A2(_user$project$Cnf$generateExpr, leftSize, seed2);
			var left = _p15._0;
			var seed3 = _p15._1;
			var _p16 = A2(_user$project$Cnf$generateExpr, rightSize, seed3);
			var right = _p16._0;
			var seed4 = _p16._1;
			var _p17 = A2(_elm_lang$core$Random$step, _elm_lang$core$Random$bool, seed4);
			var negate = _p17._0;
			var seed5 = _p17._1;
			return negate ? {
				ctor: '_Tuple2',
				_0: _user$project$Cnf$Negation(
					A2(operator, left, right)),
				_1: seed5
			} : {
				ctor: '_Tuple2',
				_0: A2(operator, left, right),
				_1: seed5
			};
		}
	});
var _user$project$Cnf$generateExpr = F2(
	function (size, seed) {
		return _elm_lang$core$Native_Utils.eq(size, 0) ? _user$project$Cnf$generateTerminal(seed) : A2(_user$project$Cnf$generateNonTerminal, size, seed);
	});
var _user$project$Cnf$transformImplications = function (expr) {
	var _p18 = expr;
	switch (_p18.ctor) {
		case 'Implication':
			var _p21 = _p18._1;
			var _p20 = _p18._0;
			var _p19 = _p20;
			if (_p19.ctor === 'Negation') {
				return A2(
					_user$project$Cnf$Disjunction,
					_user$project$Cnf$transformImplications(_p19._0),
					_user$project$Cnf$transformImplications(_p21));
			} else {
				return A2(
					_user$project$Cnf$Disjunction,
					_user$project$Cnf$Negation(
						_user$project$Cnf$transformImplications(_p20)),
					_user$project$Cnf$transformImplications(_p21));
			}
		case 'Conjunction':
			return A2(
				_user$project$Cnf$Conjunction,
				_user$project$Cnf$transformImplications(_p18._0),
				_user$project$Cnf$transformImplications(_p18._1));
		case 'Disjunction':
			return A2(
				_user$project$Cnf$Disjunction,
				_user$project$Cnf$transformImplications(_p18._0),
...
var _user$project$Cnf$moveNegation = function (expr) {
	moveNegation:
	while (true) {
		var _p22 = expr;
		switch (_p22.ctor) {
			case 'Conjunction':
				return A2(
					_user$project$Cnf$Conjunction,
					_user$project$Cnf$moveNegation(_p22._0),
					_user$project$Cnf$moveNegation(_p22._1));
			case 'Disjunction':
				return A2(
					_user$project$Cnf$Disjunction,
					_user$project$Cnf$moveNegation(_p22._0),
			...
			case 'Negation':
				switch (_p22._0.ctor) {
					case 'Negation':
						var _v9 = _p22._0._0;
						expr = _v9;
						continue moveNegation;
					case 'Conjunction':
						return A2(
							_user$project$Cnf$Disjunction,
							_user$project$Cnf$moveNegation(
								_user$project$Cnf$Negation(_p22._0._0)),
							_user$project$Cnf$moveNegation(
								_user$project$Cnf$Negation(_p22._0._1)));
					case 'Disjunction':
						return A2(
							_user$project$Cnf$Conjunction,
							_user$project$Cnf$moveNegation(
			...
			default:
				return _user$project$Cnf$Symbol(_p22._0);
		}
	}
};
var _user$project$Cnf$distribute = function (expr) {
	distribute:
	while (true) {
		var _p23 = expr;
		switch (_p23.ctor) {
			case 'Conjunction':
				return A2(
					_user$project$Cnf$Conjunction,
					_user$project$Cnf$distribute(_p23._0),
					_user$project$Cnf$distribute(_p23._1));
			case 'Disjunction':
				if (_p23._0.ctor === 'Conjunction') {
					var _p24 = _p23._1;
					return A2(
						_user$project$Cnf$Conjunction,
						_user$project$Cnf$distribute(
							A2(_user$project$Cnf$Disjunction, _p23._0._0, _p24)),
						_user$project$Cnf$distribute(
							A2(_user$project$Cnf$Disjunction, _p23._0._1, _p24)));
				} else {
					if (_p23._1.ctor === 'Conjunction') {
						var _p25 = _p23._0;
						return A2(
							_user$project$Cnf$Conjunction,
							_user$project$Cnf$distribute(
								A2(_user$project$Cnf$Disjunction, _p25, _p23._1._0)),
							_user$project$Cnf$distribute(
								A2(_user$project$Cnf$Disjunction, _p25, _p23._1._1)));
					} else {
						var b$ = _user$project$Cnf$distribute(_p23._1);
						var a$ = _user$project$Cnf$distribute(_p23._0);
						var _p26 = a$;
						if (_p26.ctor === 'Conjunction') {
							var _v12 = A2(_user$project$Cnf$Disjunction, a$, b$);
							expr = _v12;
							continue distribute;
						} else {
							var _p27 = b$;
							if (_p27.ctor === 'Conjunction') {
								var _v14 = A2(_user$project$Cnf$Disjunction, a$, b$);
								expr = _v14;
								continue distribute;
							} else {
								return A2(_user$project$Cnf$Disjunction, a$, b$);
							}
						}
					}
				}
			...
			case 'Negation':
				return _user$project$Cnf$Negation(
					_user$project$Cnf$distribute(_p23._0));
			default:
				return _user$project$Cnf$Symbol(_p23._0);
		}
	}
};
...
var _user$project$Program$ChangeSize = function (a) {
...
var _user$project$View$renderExpr = F2(
	function (expr, child) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('exprContainer')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					function () {
					...
					if (_p0.ctor === 'Nothing') {
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('expr-empty')
								]),
							_elm_lang$core$Native_List.fromArray(
								[child]));
					} else {
...
var _user$project$View$showButton = function (msg) {
	return A2(
		_elm_lang$html$Html$input,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$type$('button'),
				_elm_lang$html$Html_Attributes$value('Reveal'),
...
var _user$project$View$renderHeader = function (exprSize) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('exprSizeInput')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$for('exprSize')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Expression Size: ')
							])),
						A2(
						_elm_lang$html$Html$input,
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Basics$toString(exprSize)),
								_elm_lang$html$Html_Events$onInput(_user$project$View$parseSize)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('newExprButton')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('button'),
								_elm_lang$html$Html_Attributes$value('New Expression'),
								_elm_lang$html$Html_Events$onClick(_user$project$Program$NewFormula)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					]))
...
var _user$project$View$initializing = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Initializing')
		]));
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Initialize':
				var seed = _elm_lang$core$Random$initialSeed(_p0._0);
	...
	main: _elm_lang$html$Html_App$program(
		{
			init: {
				...
				_1: A2(
					_elm_lang$core$Random$generate,
					_user$project$Program$Initialize,
					A2(_elm_lang$core$Random$int, _elm_lang$core$Random$minInt, _elm_lang$core$Random$maxInt))
			},
